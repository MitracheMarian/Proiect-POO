...
void IncarcareActualizare::incarcare_utilizatori(vector<Utilizator>& utilizatori) {
...
void IncarcareActualizare::incarcare_tutoriale(vector<Tutorial>& tutoriale, int& numar_tutoriale) {
...
void IncarcareActualizare::incarcare_istoric(vector<Istoric>& istoric, int& numar_accesari) {
...
void IncarcareActualizare::actualizare_utilizatori(vector<Utilizator>& utilizatori) {
...
void IncarcareActualizare::actualizare_tutoriale(vector<Tutorial>& tutoriale) {
...
void IncarcareActualizare::actualizare_istoric(vector<Istoric>& istoric) {
...
void IncarcareActualizare::startProgram(vector<Tutorial>& tutoriale, vector<Utilizator>& utilizatori, vector<Istoric>& istoric, int& numar_accesari, int& numar_tutoriale) {
	incarcare_tutoriale(tutoriale, numar_tutoriale);
	incarcare_istoric(istoric, numar_accesari);
	incarcare_utilizatori(utilizatori);
}
void IncarcareActualizare::oprireProgram(vector<Tutorial>& tutoriale, vector<Utilizator>& utilizatori, vector<Istoric>& istoric) {
